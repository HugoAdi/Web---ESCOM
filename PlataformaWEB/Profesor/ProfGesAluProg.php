                            ...
                            <ul>
                                <li><a>Tipo de Material</a>
                                    <ul>
                                        ...
                                        <li><a href = "ProfGesTema-Evaluacion.ph">Examen o evaluacion</a></li>
                                    </ul> 
                                </li>
                ...
                <div id="section">
                    <div id="articulo">
                        <?php
                            ...
                            $id=$_POST['id'];
                            $id1=mysqli_query($conexion, "SELECT * FROM alumno WHERE progreso='0'");
                        ?>
                        ...
                        <form action="ProfGesAlu.php">
                            <input type="submit" name="consultageneral" value="Consulta General">
                        </form>
                        <form action="ProfselGrupo.php">
                            <input type="submit" name="consultagrupo" value="Consulta por Grupo">
                        </form>
                        <form action="#">
                            <input type="submit" name="consultaprogreso" value="Consulta por Progreso">
                        </form>
                    </div>
                </div>
            </div>
