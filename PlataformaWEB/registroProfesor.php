        ...
        <div id="header">
            ...
            <div id="contenido">
                ...
                <form action method="POST">
                    ...
                    <br><br><br><br>
                    <label for="NumEmp"><b>Ingrese su numero de Empleado:</b></label>
                    <input type="text" placeholder="Numero" name="NumEmp" id="NumEmp" required>

                    <label for="NumEmp"><b>Ingrese su Id de Grupo:</b></label>
                    <input type="text" placeholder="Numero" name="IdGrupo" id="IdGrupo" required>

                    <label for="NumEmp"><b>Ingrese su Id de Agenda:</b></label>
                    <input type="text" placeholder="Numero" name="IdAgenda" id="IdAgenda" required>
                ...
                if ($_POST) {
                    ...
                    mysqli_query($conexion, "INSERT INTO profesor(Id,No_empleado,Id_grupo,Id_Agenda) VALUES('$id1','$numero','$IdGrupo','$IdAgenda')");
