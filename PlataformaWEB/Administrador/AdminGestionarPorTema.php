...
<html>
    ...
    <body>
        <div id="contenedor">
            ...
            <div id="contenido">
                <form action method="POST" style="height: 200px; margin-top:20px">
                    <div class="container">
                        <div class="item1">
                            <label for="ftemaaconsultar">Tema a consultar</label>
                            <input type="text" id="fname" name="ftemaaconsultar" placeholder="">
                        </div>
                        <input type="submit" value="Consultar">
                    </div>
                </form>
                <div id="articulo" style="height: 300px;">
                    <?php
                        include("conexion.php");
                        if ($_POST) {
                            $temaaconsultar = $_POST['ftemaaconsultar'];
                        }
                        $id1 = mysqli_query($conexion, "SELECT * FROM material WHERE Tema='$temaaconsultar'");
                    ?>
                    <div style="overflow-x: scroll; overflow-y: scroll; height: 75%;width:100%;margin-bottom: 20px;">
                        <table>
                            <tbody>
                                <tr>
                                    <th>Id</th>
