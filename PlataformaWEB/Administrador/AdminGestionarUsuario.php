            ...
            <div id="contenido">
                <div id="articulo">
                    ...
                    <div style="overflow-x: scroll; overflow-y: scroll; height: 80%;width:100%;margin-bottom: 20px;">
                        ...
                        <button class="button" ><a href="/Administrador/AdminAgregarUsuario.php">Agregar</a></button>
                        <button class="button"><a href="/Administrador/AdminEliminarUsuario.php">Eliminar</a></button>
                        <button class="button"><a href="/Administrador/AdminGestionarUsuario.php">Consultar</a></button>
                        <button class="button"><a href="/Administrador/AdminModificarUsuario.php">Modificar</a></button>
